                ...
                <div class="container">
                    <div class="row">
                        <div class="col-md-12">
                            <div class="title">
                                <h2> Categories</h2>
                                <ul class="categiri" id="brand-category">
                                    <li class="active"><a href="#products" data-link="men">Men</a></li>
                                    <li><a href="#products" data-link="women">Women</a></li>
                                    <li><a href="#products" data-link="kids">Kids</a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
                    ...
                    <div id="products">
                        <!-- Men -->
                        <div id="brand-men"  class="brand-bg">
                            <h3>Men's Fashion</h3>
                            <div class="row">
                                <jsp:include page="productList.jsp">
                                	<jsp:param value="men" name="category"/>
                                </jsp:include>
                            </div>
                        </div>
                        <!-- end men -->
                        ...
                        <!-- Women -->
                        <div id="brand-women"  class="brand-bg" style="display: none;">
                            <h3>Women's Fashion</h3>
                            <div class="row">                                                            
                                <jsp:include page="productList.jsp">
                                	<jsp:param value="women" name="category"/>
                                </jsp:include>                               
                            </div>
                        </div>
                        <!-- end women -->
                        ...
                        <!-- kids -->
                        <div id="brand-kids"  class="brand-bg" style="display: none;">
                            <h3>Kids Fashion</h3>
                            <div class="row">
                                <jsp:include page="productList.jsp">
                                	<jsp:param value="kids" name="category"/>
                                </jsp:include>
                            </div>
                        </div>
                        <!-- end kids -->
