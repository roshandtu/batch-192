    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav mr-auto">
        ...
        <li class="nav-item dropdown">
          ...
          <div class="dropdown-menu" aria-labelledby="navbarDropdown">
            <a class="dropdown-item" href="Male.jsp">Male</a>
            <a class="dropdown-item" href="Female.jsp">Female</a>
            <a class="dropdown-item" href="Kids.jsp">Kids</a>
            <div class="dropdown-divider"></div>
            <a class="dropdown-item" href="#">Choose your Category</a>
          </div>
        </li>
        <li class="nav-item">
          <a class="nav-link" href="#">KART <span class="sr-only">(current)</span></a>
        </li>
      </ul>
...
<div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
    ...
    <div class="carousel-inner">
      <div class="carousel-item active">
        <img src="images/19155989.jpg" class="d-block w-100" alt="...">
      </div>
      <div class="carousel-item">
        <img src="images/23.gif" class="d-block w-100" alt="...">
      </div>
      <div class="carousel-item">
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-9 col-sm-9 col-xs-12">
                <h3><span class="glyphicon glyphicon-cog "></span> <b>SEE YOUR KART HERE</b> WHAT YOU GOT.</h3>
            </div>
            <div class="col-md-3 col-sm-3 col-xs-12 ">
               <form method="get" action="/page2">
    <button type="submit">Your Kart</button>
</form>
	...
	<div class="container">
	  <div class="row">
		<div class="col-xs-12 col-sm-6 col-md-3 footer-one">
		    <img src="https://w7.pngwing.com/pngs/257/702/png-transparent-about-us-logo-business-logo-company-brand-service-icon-about-us-hd-miscellaneous-blue-text-thumbnail.png" alt="Logo" style="width:120px;">
